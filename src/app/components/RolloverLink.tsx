const RolloverLink = ({
  ...
  return (
    ...
    >
      <span
        className="bg-black absolute top-0 left-0 overflow-hidden transform -translate-x-full transition-transform duration-500 delay-200 ease-in-out group-hover:translate-x-0 before:inline-block before:content-[attr(data-content)] before:text-white before:transform before:translate-x-full before:duration-500 before:delay-200 before:ease-in-out group-hover:before:transform group-hover:before:translate-x-0"
        data-content={text}
        aria-hidden="true"
      ></span>
      {text}
